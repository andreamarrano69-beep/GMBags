...
values
  ...
  ('contatt', 'Puoi scriverci su WhatsApp al +39 392 596 1105 oppure via email a gmbags@gmail.com. Ti rispondiamo il prima possibile!', false, true),
  ('whatsapp', 'Scrivici su WhatsApp al +39 392 596 1105, ti rispondiamo il prima possibile!', false, true),
  ('', 'Grazie per la tua domanda! Per informazioni scrivici su WhatsApp al +39 392 596 1105 o via email a gmbags@gmail.com', true, true);
