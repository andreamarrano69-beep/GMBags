...
values
  ...
  ('prezzo', 'Il prezzo varia in base al modello. Scrivici via email il prodotto che ti interessa e ti rispondiamo subito!', false, true),
  ('spedizion', 'Scrivici via email per organizzare insieme spedizione o ritiro del tuo ordine.', false, true),
  ('contatt', 'Puoi scriverci via email a gmbags2026@gmail.com. Ti rispondiamo il prima possibile!', false, true),
  ('', 'Grazie per la tua domanda! Per informazioni scrivici via email a gmbags2026@gmail.com', true, true);
