...
values
  ...
  ('contatt', 'Puoi scriverci su WhatsApp (link nella pagina Contatti) oppure via email a gmbags@gmail.com. Ti rispondiamo il prima possibile!', false, true),
  ('whatsapp', 'Scrivici su WhatsApp dalla pagina Contatti del sito, ti rispondiamo il prima possibile!', false, true),
  ('', 'Grazie per la tua domanda! Per informazioni scrivici su WhatsApp (link nella pagina Contatti) o via email a gmbags@gmail.com', true, true);
